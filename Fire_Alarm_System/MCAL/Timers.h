...
typedef enum{
	TIMER0_STOP=0,  // Turn off the timer.
	TIMER0_SCALER_1,
	TIMER0_SCALER_8,
	TIMER0_SCALER_64,
	TIMER0_SCALER_256,
...
typedef enum{
	TIMER1_STOP=0,  // Turn off the timer.
	TIMER1_SCALER_1,
	TIMER1_SCALER_8,
	TIMER1_SCALER_64,
	TIMER1_SCALER_256,
...
typedef enum  /*this are the most used modes among 16 mode ,you can complete them here and on init fun*/ 
{
...
typedef enum{
	TIMER2_STOP=0,  // Turn off the timer.
	TIMER2_SCALER_1,
	TIMER2_SCALER_8,
	TIMER2_SCALER_64,
	TIMER2_SCALER_256,
